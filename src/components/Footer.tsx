            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-2.5">
                <a
                  ...
                  className="p-2.5 border border-(--border-subtle) hover:border-(--border-strong) bg-(--bg-primary) rounded-xs hover:text-vermilion transition-colors flex items-center justify-between group"
                >
                ...
                {PERSONAL_INFO.upwork && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2.5 border border-(--border-subtle) hover:border-[#14a800]/50 bg-(--bg-primary) rounded-xs hover:text-[#14a800] transition-colors flex items-center justify-between group"
                  >
                    <div className="flex items-center gap-2">
